        ...
        <div className='feedback__form__container'>
            <div className='feedback__form'>
                ...
                <div className='feedback__form__details'>
                    ...
                    <div className="field">
                        <input type="text" placeholder="What's your email ID?" value={email} onChange={(e) => setEmail(e.target.value)} />
                        <div className="line"></div>
                    </div>
                    ...
                    <label>Feel free to report issues, give feedback, or contribute your suggestions.</label>
                    <textarea className='text' placeholder='Enter Feedback or Suggestions' value={feedback} onChange={(e) => setFeedback(e.target.value)} />
                    {feedbackError && <p className="error__message">{feedbackError}</p>}
                    <div className='form__submit__btn'>
                        <button className='feedback__submit__btn' onClick={handleSubmit}>Submit</button>
                    </div>
                </div>
            </div>
        </div>
