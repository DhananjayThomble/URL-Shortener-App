 ...
 *  surface — LISTEN/NOTIFY (#470's cross-process cache-bust signal), for
 *  instance — can type against it without importing the `postgres` package
 *  itself just to name the type. */
